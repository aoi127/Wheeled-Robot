...
def parse_yolo_region(blob, resized_image_shape, original_im_shape, params, threshold):
    ...
    #print(blob[0, 0, 0, 0, :])
    out_blob_n, out_blob_c, out_blob_h, out_blob_w = blob.shape[:4]
    ...
    for row, col, n in np.ndindex(params.side, params.side, params.num):
        bbox = predictions[0, n*bbox_size:(n+1)*bbox_size, row, col][0]
...
def main():
    ...
    #print(model)
    net = ie.read_network(model=model,weights = os.path.splitext(model)[0] + ".bin")
